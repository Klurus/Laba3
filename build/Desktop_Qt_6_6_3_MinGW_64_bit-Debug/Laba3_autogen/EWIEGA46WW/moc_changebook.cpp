...
Q_CONSTINIT static const qt_meta_stringdata_CLASSChangeBookENDCLASS_t qt_meta_stringdata_CLASSChangeBookENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 11),  // "sendChanges"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 8),  // "QString*"
        QT_MOC_LITERAL(33, 22)   // "on_savechanges_clicked"
    },
    "ChangeBook",
    "sendChanges",
    "",
...
void ChangeBook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendChanges((*reinterpret_cast< std::add_pointer_t<QString*>>(_a[1]))); break;
        ...
        {
            using _t = void (ChangeBook::*)(QString * );
            if (_t _q_method = &ChangeBook::sendChanges; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChangeBook::sendChanges(QString * _t1)
{
